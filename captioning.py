...
from utils_log import write_log
...
parser.add_argument("--rid", default = 0, type=int)
...
def captioning(args):
    save_dir = f"/root/musicai/music_captioning/exp/{args.framework}/{args.caption_type}/"
    ...
    for chunk, text in zip(number_of_chunks, output):
        ...
        write_log(args.rid,"step_music_captioning",item)
